...
//for final class we can create the object but cannot be inherited(cannot be a child class)
...
public final class Third {
	...
	public String sayHello(String s) { //instance method
	  ...
	  public static void main(String[] args) { 
	    ...
	    Third fobj = new Third();

	  System.out.println("CollegeCode : "+fobj.collegeCode); 

	  //final variable value is constant //try to change the final variable value
